...
class ServicesConfigUtils {
    ...
    /**
     * Package de base des applis, dans lequel on recherche des services à déployer
     */
     ...
     * "annotation"
     *
     * @param beanList   liste des beans trouvés
     * @param annotation annotation utilisée pour la recherche des classes
     */
     ...
     *
     * @param classList  liste des classes trouvées
     * @param annotation annotation sur les classes recherchées
     */
